...
export default function TransactionList() {
  const { transactions, pagination, setPagination, deleteTransaction } =
    useTransactions();
                ...
                <Th
                  ...
                  onClick={() => {
                    if (sort !== undefined) {
                      ...
                      if (sort === currentSort) newSort = "-" + sort; // to desc
                      ...
                      <PromptActionButton
                        ...
                        onClick={async () => {
                          const { transaction, error } =
                            await deleteTransaction(t.id, user.accessToken);
